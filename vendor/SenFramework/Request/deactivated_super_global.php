...
class deactivated_super_global implements \ArrayAccess, \Countable, \IteratorAggregate
{
	...
	*/
	...
	/**
	* @var	\SenFramework\Request\request_interface::POST|GET|REQUEST|COOKIE	Super global constant.
	*/
	private $super_global;

	/**
	* @var	\SenFramework\Request\request_interface	The request class instance holding the actual request data.
	*/
	private $request;
	...
	*
	* @param	\SenFramework\Request\request_interface	$request	A request class instance holding the real super global data.
	* @param	string					$name		Name of the super global this is a replacement for - e.g. '_GET'.
	* @param	\SenFramework\Request\request_interface::POST|GET|REQUEST|COOKIE	$super_global	The variable's super global constant.
	*/
	public function __construct(\SenFramework\Request\request_interface $request, $name, $super_global)
	{
