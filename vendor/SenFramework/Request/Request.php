...
namespace SenFramework\Request;
...
*/
class Request implements \SenFramework\Request\request_interface
{
	/**
	...
	*/
	protected $super_globals = array(
		\SenFramework\Request\request_interface::POST => '_POST',
		\SenFramework\Request\request_interface::GET => '_GET',
		\SenFramework\Request\request_interface::REQUEST => '_REQUEST',
		\SenFramework\Request\request_interface::COOKIE => '_COOKIE',
		\SenFramework\Request\request_interface::SERVER => '_SERVER',
		\SenFramework\Request\request_interface::FILES => '_FILES',
	);
	...
	*/
	...
	/**
	* @var	\SenFramework\Request\type_cast_helper_interface	An instance of a type cast helper providing convenience methods for type conversions.
	*/
	protected $type_cast_helper;

	/**
	* Initialises the request class, that means it stores all input data in {@link $input input}
	* and then calls {@link \SenFramework\Request\deactivated_super_global \SenFramework\Request\deactivated_super_global}
	*/
	public function __construct(\SenFramework\Request\type_cast_helper_interface $type_cast_helper = null, $disable_super_globals = true)
	{
		if ($type_cast_helper)
		{
		...
		{
			$this->type_cast_helper = new \SenFramework\Request\type_cast_helper();
		}
		...
		$this->original_request = $this->input[\SenFramework\Request\request_interface::REQUEST];
		$this->input[\SenFramework\Request\request_interface::REQUEST] = $this->input[\SenFramework\Request\request_interface::POST] + $this->input[\SenFramework\Request\request_interface::GET];
	...
	* This is achieved by overwriting the super globals with instances of {@link \SenFramework\Request\deactivated_super_global \SenFramework\Request\deactivated_super_global}
	*/
	public function disable_super_globals()
	{
		if (!$this->super_globals_disabled)
		{
			foreach ($this->super_globals as $const => $super_global)
			{
				...
				$GLOBALS[$super_global] = new \SenFramework\Request\deactivated_super_global($this, $super_global, $const);
			}
	...
	* @param	\SenFramework\Request\request_interface::POST|GET|REQUEST|COOKIE	$super_global
	* 								Specifies which super global shall be changed
	*/
	public function overwrite($var_name, $value, $super_global = \SenFramework\Request\request_interface::REQUEST)
	{
	...
	*/
	public function variable($var_name, $default, $multibyte = false, $super_global = \SenFramework\Request\request_interface::REQUEST)
	{
	...
	*					the same as that of $default. If the variable is not set $default is returned.
	*/
	public function untrimmed_variable($var_name, $default, $multibyte = false, $super_global = \SenFramework\Request\request_interface::REQUEST)
	{
	 ...
	 * {@inheritdoc}
	 */
	public function raw_variable($var_name, $default, $super_global = \SenFramework\Request\request_interface::REQUEST)
	{
		$path = false;
	...
	* whatever).
	*
	* @param	string|array	$var_name		See \SenFramework\Request\request_interface::variable
	* @param	mixed			$Default		See \SenFramework\Request\request_interface::variable
	*
	...
	*/
	public function server($var_name, $default = '')
	{
		...
		if ($this->is_set($var_name, \SenFramework\Request\request_interface::SERVER))
		{
			return $this->variable($var_name, $default, $multibyte, \SenFramework\Request\request_interface::SERVER);
		}
		else
		{
			$var = getenv($var_name);
	...
	*/
	...
	{
		return $this->variable($form_name, array('name' => 'none'), true, \SenFramework\Request\request_interface::FILES);
	}
	...
	*/
	...
	{
		return $this->is_set($name, \SenFramework\Request\request_interface::POST);
	}
	...
	*/
	public function is_set($var, $super_global = \SenFramework\Request\request_interface::REQUEST)
	{
	...
	*/
	public function variable_names($super_global = \SenFramework\Request\request_interface::REQUEST)
	{
	...
	*					the same as that of $default. If the variable is not set $default is returned.
	*/
	protected function _variable($var_name, $default, $multibyte = false, $super_global = \SenFramework\Request\request_interface::REQUEST, $trim = true)
	{
	...
	* {@inheritdoc}
	*/
	public function get_super_global($super_global = \SenFramework\Request\request_interface::REQUEST)
	{
